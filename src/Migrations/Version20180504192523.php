 ...
 */
class Version20180504192523 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE attire_category (id INT AUTO_INCREMENT NOT NULL, abbreviation VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, nameSlug VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_4F668D3071D12548 (nameSlug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE metal_maiden (id INT AUTO_INCREMENT NOT NULL, attire_category_id INT DEFAULT NULL, nation_id INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, attire VARCHAR(255) NOT NULL, attireSlug VARCHAR(255) NOT NULL, rarity INT DEFAULT 0 NOT NULL, portrait_image_name VARCHAR(255) DEFAULT NULL, portrait_image_size INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_A18047EDFDB27294 (attire), UNIQUE INDEX UNIQ_A18047ED4807BC0A (attireSlug), INDEX IDX_A18047ED68D60284 (attire_category_id), INDEX IDX_A18047EDAE3899 (nation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
